...
AddLSShipHabModel("SmallBridge, T-Junction, SW, Long","models/SmallBridge/SBcorridorTdl/sbcorridortdl.mdl")
AddLSShipHabModel("SmallBridge, T-Junction, SW, Long DW","models/SmallBridge/SBcorridorTdldw/sbcorridortdldw.mdl")
...
AddLSShipHabModel("SmallBridge, Cockpit 1","models/SmallBridge/SBbridge1s/sbbridge1s.mdl")
...
AddLSShipHabModel("SmallBridge, Empty Door Hull, SW","models/SmallBridge/SBhullEdoors/sbhulledoors.mdl.mdl")
AddLSShipHabModel("SmallBridge, Empty Door Hull 2, SW","models/SmallBridge/SBhullEdoors2/sbhulledoors2.mdl.mdl")
AddLSShipHabModel("SmallBridge, Empty Door Hull, DW","models/SmallBridge/SBhullEdoorsdw/sbhulledoorsdw.mdl")
AddLSShipHabModel("SmallBridge, Empty Door Hull 2, DW","models/SmallBridge/SBhullEdoorsdw2/sbhulledoorsdw2.mdl.mdl")
...
AddLSShipHabModel("SmallBridge, Engine 1","models/SmallBridge/SBengine1s/sbengine1s.mdl")
AddLSShipHabModel("SmallBridge, Doublewidth Engine 1","models/SmallBridge/SBenginedw1s/sbenginedw1s.mdl")
AddLSShipHabModel("SmallBridge, Engine SW1 Left","models/SmallBridge/SBenginesw1Ls/sbenginesw1Ls.mdl")
AddLSShipHabModel("SmallBridge, Engine SW1 Middle","models/SmallBridge/SBenginesw1Ms/sbenginesw1Ms.mdl")
AddLSShipHabModel("SmallBridge, Engine SW1 Right","models/SmallBridge/SBenginesw1Rs/sbenginesw1Rs.mdl")
...
AddLSShipHabModel("SmallBridge, SmallBridge to Medbridge","models/SmallBridge/SBconverterSBtoMB/sbconvertersbtomb.mdl")
