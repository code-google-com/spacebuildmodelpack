...
AddLSShipHabModel("SmallBridge, Cockpit 2","models/SmallBridge/SBbridge1/sbbridgeo1.mdl")
AddLSShipHabModel("SmallBridge, Cockpit 2 Base","models/SmallBridge/SBbridge1/sbbridgeo1base.mdl")
...
AddLSShipHabModel("SmallBridge, Visor Bridge","models/SmallBridge/SBcommandBridge1/sbvisorbridge1.mdl")
