...
list.Set("SBMP_ElevatorMdls","models/SmallBridge/Ship Parts/SBlandRampP.mdl",         EmptyTable)
...
list.Set("SBMP_ElevatorMdls","models/Slyfowalls/flightbase1_door.mdl", EmptyTable)
