...
AddLSShipHabModel("Medium Birdge 2, Double, Empty","models/Spacebuild/medbridge2_emptydoublehull.mdl")
AddLSShipHabModel("Medium Birdge 2, Double, Ramps","models/Spacebuild/medbridge2_emptydoublehull_decktodeckramp.mdl")
AddLSShipHabModel("Medium Birdge 2, Mid sec. Bridge","models/Spacebuild/medbridge2_midsectionbridge.mdl")
AddLSShipHabModel("Medium Birdge 2, Single to double","models/Spacebuild/medbridge2_singletodoublehull.mdl")

AddLSShipHabModel("Small Bridge, NAME","models/SmallBridge/SBcorridorFlip/sbcorridorflip.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorE1/sbcorridore1.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorE2/sbcorridore2.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorE3/sbcorridore3.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorE4/sbcorridore4.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorR/sbcorridorr.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorT/sbcorridort.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorX/sbcorridorx.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorEdw/sbcorridoredw.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorEdw2/sbcorridoredw2.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorEnd/sbcorridorend.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorCurveS/sbcorridorcurves.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorFlip/sbcorridorflip.mdl")
...
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorEStoDW/sbcorridorestodw.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorEDto2SW/sbcorridoredto2sw.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorV/sbcorridorv.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBbridge1/sbbridge1.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBcorridorEdoors/sbcorridoredoors.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBEdoors/sbedoors.mdl")
AddLSShipHabModel("Small bridge, NAME","models/SmallBridge/SBengine1/sbengine1.mdl")
