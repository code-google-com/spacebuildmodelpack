...
list.Set("sbepfighters","sword",{VecOff=Vector(0,0,0), AngOff=Angle(0,0,0), Docklist={"swordhangar", "swordhangarlarge", "swordhangarspacious", "dockingclamp", "dockingclampt", "dockingclampx"}})
--is is programmed differently
list.Set("sbepfighters","assaultpodc",{VecOff=Vector(50,0,75), AngOff=Angle(0,0,0), Docklist=all})
--Drone = Clunker, damned if I know why
list.Set("sbepfighters","drone",{VecOff=Vector(50,0,0), AngOff=Angle(0,0,0), Docklist=all})
...
list.Set("sbepfighters","arwing",{VecOff=Vector(50,0,50), AngOff=Angle(0,0,0), Docklist={/*"swordhangar", "swordhangarlarge", */"swordhangarspacious", "dockingclamp", "dockingclampt", "dockingclampx"}})
--The light corvette fits into hangars easily, even smallbridge
list.Set("sbepfighters","lightcombatcorvette",{VecOff=Vector(100,0,50), AngOff=Angle(0,0,0), Docklist=all})
