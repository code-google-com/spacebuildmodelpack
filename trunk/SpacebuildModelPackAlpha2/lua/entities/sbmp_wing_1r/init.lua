...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/Spacebuild/milcock4_wing1.mdl" ) 
	self.Entity:SetName("Wing1R")
	...
	self.HP[1]["Pos"]	= Vector(0,24,0)
	self.HP[1]["Angle"] = Angle(0,180,180)
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "sbmp_wing_1r" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Activate()
	ent.SPL = ply
