...
function ENT:Initialize()
	...
	self.Bay = {}
	self.Bay[1] = {ship = nil, weld = nil, pos = Vector(-50, 400, -100), ang = Angle(0,0,0), pexit = Vector(-50, 200, -100)}
	self.Bay[2] = {ship = nil, weld = nil, pos = Vector(-50,-400, -100), ang = Angle(0,0,0), pexit = Vector(-50,-200, -100)}
	self.Bay[3] = {ship = nil, weld = nil, pos = Vector(-50, 400, -300), ang = Angle(0,0,0), pexit = Vector(-50, 200, -300)}
	self.Bay[4] = {ship = nil, weld = nil, pos = Vector(-50,-400, -300), ang = Angle(0,0,0), pexit = Vector(-50,-200, -300)}
