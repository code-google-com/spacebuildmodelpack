...
function ENT:Initialize()
	...
	self.Bay = {}
	self.Bay[1] = {ship = nil, weld = nil, pos = Vector(0, 400, -300), canface = {"forward","backward"}, pexit = Vector(0, 200, -300)}
	self.Bay[2] = {ship = nil, weld = nil, pos = Vector(0,-400, -300), canface = {"forward","backward"}, pexit = Vector(0,-200, -300)}
