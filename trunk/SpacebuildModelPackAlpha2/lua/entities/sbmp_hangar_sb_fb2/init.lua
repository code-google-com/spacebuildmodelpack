...
function ENT:Initialize()
	...
	self.Entity:SetModel( "models/SmallBridge/SBhangardhdw1UD/sbhangardhdw1ud.mdl" )
	self.Entity:SetName("sbfighterbay2")
	...
	self.Bay[1]["ship"] = nil
	self.Bay[1]["weld"] = nil
	self.Bay[1]["pos"] = Vector(0,320,0)
	self.Bay[1]["canface"] = {Angle(0,0,0),Angle(0,180,0)}
	self.Bay[1]["pexit"] = Vector(0,256,0)
	self.Bay[2] = {}
	self.Bay[2]["ship"] = nil
	self.Bay[2]["weld"] = nil
	self.Bay[2]["pos"] = Vector(0,-320,0)
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "sbmp_hangar_sb_fb2" )
	ent:SetPos( SpawnPos )
	ent:Spawn()
	ent:Initialize()
	ent:Activate()
