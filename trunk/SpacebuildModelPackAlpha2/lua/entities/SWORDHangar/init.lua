...
function ENT:Initialize()
	...
	self.Bay = {}
	self.Bay["Right"] = {ship = nil, weld = nil, pos = Vector(0,400,-100), canface = {Angle(0,0,0),Angle(0,180,0)}, pexit = Vector(0,200,-100)}
	self.Bay["Left"] = {ship = nil, weld = nil, pos = Vector(0,-400,-100), canface = {Angle(0,0,0),Angle(0,180,0)}, pexit = Vector(0,-200,-100)}
