...
AddLSShipDefResModel("small cache", "models/props_lab/presourcecachesmall.mdl")
...
AddLSShipDefResModel("large cache", "models/props_lab/resourcecachelarge.mdl")
AddLSShipDefResModel("medium cache", "models//Spacebuild/resourcecachehuge.mdl")
