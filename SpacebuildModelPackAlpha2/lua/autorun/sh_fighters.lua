...
list.Set("sbepfighters","wraith",			{VecOff=Vector(-4,0,-92), 	AngOff=Angle(0,0,0), Docklist=huge})
...
list.Set("sbepfighters","stingray",			{VecOff=Vector(-62,0,24),	AngOff=Angle(0,0,0), Docklist=small})
list.Set("sbepfighters","shuttle",			{VecOff=Vector(0,0,0),	 	AngOff=Angle(0,0,0), Docklist=small})
list.Set("sbepfighters","shuttle2",			{VecOff=Vector(-67.5,0,32),	AngOff=Angle(0,0,0), Docklist=small})
list.Set("sbepfighters","shuttle3",			{VecOff=Vector(0,0,0),	 	AngOff=Angle(0,0,0), Docklist=small})
list.Set("sbepfighters","shuttle4",			{VecOff=Vector(0,0,0),	 	AngOff=Angle(0,0,0), Docklist=small})
