...
list.Set("sbepfighters","arwing",{VecOff=Vector(0,0,50), AngOff=Angle(0,0,0), Docklist={--[["swordhangar", "swordhangarlarge", ]]"swordhangarspacious", "dockingclamp", "dockingclampt", "dockingclampx","deck","deckdouble","deckdoublewide"}})
--The light corvette fits into hangars easily, even smallbridge
list.Set("sbepfighters","lightcombatcorvette",{VecOff=Vector(75,0,50), AngOff=Angle(0,0,0), Docklist=all})
