...
local model = { "models/SmallBridge/SEnts/SBAhullDsEb.mdl" , "models/SmallBridge/Ship Parts/SBhullDsP.mdl" }
...
function ENT:SpawnFunction( ply, tr )
	...
	local ent = ents.Create( "sbep_smb_door_hull" )
	ent:SetPos( SpawnPos )
