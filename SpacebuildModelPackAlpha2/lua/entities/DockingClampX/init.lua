...
function ENT:Initialize()
	...
	self.Bay = {}
	self.Bay[1] = {ship = nil, weld = nil, pos = Vector(0,-600,-100), canface = {"forward","backward"}, pexit = Vector(0,-300,-85)}
	self.Bay[2] = {ship = nil, weld = nil, pos = Vector(0, 600,-100), canface = {"forward","backward"}, pexit = Vector(0, 300,-85)}
